...
package com.example.gpuimagetest.filter;

import static com.example.gpuimagetest.GPUImageRenderer.CUBE;
import static com.example.gpuimagetest.util.TextureRotationUtil.TEXTURE_NO_ROTATION;

import android.annotation.SuppressLint;
import android.opengl.GLES20;

import com.example.gpuimagetest.GPUImageRenderer;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public GPUImageFilterGroup(List<GPUImageFilter> filters) {
        ...
        glCubeBuffer = ByteBuffer.allocateDirect(GPUImageRenderer.CUBE.length * 4)
